                ...
                <div className="flex items-center gap-4">
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button onClick={copyLink} className="text-[10px] bg-zinc-800 hover:bg-zinc-700 px-2 py-0.5 ronded text-zinc-400 hover:text-zinc-200 transition-colors">
                                {copyStatus}
                            </button>
                        </div>
                    </div>
                ...
                {messages?.messages.map((msg) => (
                    <div key={msg.id} className="flex flex-col items-start">
                        <div className="max-w-[80%] group">
                            <div className="flex flex-col items-baseline gap-3 mb-1  ">
            ...
            <div className="p-4 border-t border-zinc-800 bg-zinc-900/30">
                <div className="flex gap-4">
                    <div className="flex-1 relative group">
                        ...
                        autoFocus
                        type="text"
                        className="w-full bg0black border border-zinc-800 focus:border-zinc-700 focus:outline-none transition-colors text-zinc-100 placeholder:text-zinc-700 py-3 pl-8 pr-4 text-sm"
                        />
                    </div>
                    <button onClick={() => {
                        sendMessage({ text: input })
